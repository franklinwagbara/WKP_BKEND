...
namespace Backend_UMR_Work_Program
{
    public class SendMailToCompanies_Job : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            wp_check_ADMIN_COMPANY_INFORMATION_Table_and_send_email();

           // wp_check_ADMIN_DATETIME_PRESENTATION_Table_and_send_email_Divisional_Representative();


            //SendMailDNPlus(ToName, FromName, FromAddress, To, ToCC, RequestStatus, AdditionalMailData, AdditionalMailData2, DNStatusColor, SubjectDNPlus, MessageCSSDNPlus, MessageDNPlus);
        }
        ...
        private void Work_Program_Email_Notification()
        {
            ...
            //requester_mail.NES_subject = "Work Program Data Upload Reminder";

            ////requester_mail.Official_name = " <b> " + officiating_names + "  </b> ";

            //requester_mail.NES_body = "Work Program Data Upload Reminder - See details below";

            //requester_mail.Company_operator_name = COMPANYNAME;

            //requester_mail.Days_to_go = Check_Days_to_send_Email + "Day(s)";

            //requester_mail.ToRecieved = company_rep_email;
            ...
            //requester_mail.ToRecievedCC = company_rep_email; // "anthony.nwosu@brandonetech.com";
            ...
            //requester_mail.SendMail_Notification_to_Companies();
            ...
            string subject = "Work Program Data Upload Reminder";

            string nes_body = "Work Program Data Upload Reminder - See details below";
            ...
            string to = company_rep_email;// "anthony.nwosu@brandonetech.com"; //To address    
            ...
            string mailbody = "<html><body>" + "<table width=100% border=0 bordercolor=#CCCCCC cellspacing=0 cellpadding=0>" +
                ...
                + "<span style=\"font-size: 13 px; color:#000000; font-family:Trebuchet MS, Myriad Pro, Arial\">"
                 ...
                 + "Dear " + COMPANYNAME + ", <br>" + "</span>" + "</td>" + "</tr>" + "<tr>" + "<td align=left valign=top>" + "<p>" + "<span style=\"font-size: 13 px; color:#000000; font-family:Trebuchet MS, Myriad Pro, Arial\"> "
        ...
        private void Work_Program_Email_Notification_divisional_representative()
        {
            ...
            //  requester_mail.ToRecievedCC = "okoro.e.e@dpr.gov.ng , anthony.nwosu@brandonetech.com";
        ...
        private void wp_check_ADMIN_COMPANY_INFORMATION_Table_and_send_email()
        {
            ...
            for (int m = 0; m < count_record; m++)
            {
                try
                {
                    ...
                    company_rep_email = result.Rows[m]["EMAIL"].ToString(); // 

                    if (company_rep_email == "")
                    {
                        company_rep_email = "no_scribe_email@nuprc.gov.ng";
                    }
                    ...
                    {
                        DateTime Close_date_scheduled = System.Convert.ToDateTime(Close_date); // This Holds the value for the initiation date ...
                        ...
                        ts_totalduration = Close_date_scheduled.Subtract(System_endDate);
                        ...
                        for (DateTime tempDt = System_endDate; tempDt.Date < Close_date_scheduled.Date; tempDt = tempDt.AddDays(1))
                        {
                            if (tempDt.DayOfWeek == DayOfWeek.Saturday || tempDt.DayOfWeek == DayOfWeek.Sunday)
                                weekends++;
                        }
        ...
        private void Update_EMAIL_INFORMATION()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "Update ADMIN_DATETIME_PRESENTATION  SET  LAST_RUN_DATE = '" + systemdate_email + "' ,  DAYS_TO_GO = '" + email_days_to_go + "'   WHERE  Id  = '" + id + "' ";
                cmd.ExecuteNonQuery();
            }
            catch (Exception ex)
            {
