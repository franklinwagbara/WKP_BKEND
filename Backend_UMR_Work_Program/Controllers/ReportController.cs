                                    ...
                                    foreach (var field in concession.Fields)
                                    {
                                        if (field != null)
                                        {
                                            ...
                                            var summary = new ExecutiveSummaryRowDTO
                                            {
                                                ...
                                                Concession = concession,
                                                Field = field,
                                                ReservesOil = Convert.ToDouble(data?.Reserves?.Company_Reserves_Oil).ToString("N2"),
                                                ReservesGas = Convert.ToDouble(data?.Reserves?.Company_Reserves_AG).ToString("N2"),
                                                ExReservesAdditionOil = Convert.ToDouble(data?.ExRAddition?.Reserves_Addition_Oil).ToString("N2"),
                                                ExReservesAdditionGas = Convert.ToDouble(data?.ExRAddition?.Reserves_Addition_AG).ToString("N2"),
                                                ...
                                                ProductionOilCondensate = (Convert.ToDouble(data?.productionOilCondensate?.Company_Oil) + Convert.ToDouble(data?.productionOilCondensate?.Company_Condensate)).ToString("N2"),
                                                ProductionGas = (Convert.ToDouble(data?.productionOilCondensate?.Gas_AG) + Convert.ToDouble(data?.productionOilCondensate?.Gas_NAG)).ToString("N2"),
                                                FDPPlanProjects = plannedProjects,
                                                FDPCompletionTimeline = projectTimelines,
